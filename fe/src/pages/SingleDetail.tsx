  ...
  return (
    <div>
        ...
        <div className="col-span-1 md:col-span-2 ">
            <img className="w-full h-[500px] object-cover shadow-md rounded-md" src={singleProduct?.image} />
        </div>
        <div className="col-span-1 md:col-span-3  ml-4 flex flex-col">
            <div className="mb-6 text-[30px] font-bold">{singleProduct?.title}</div>
            <div>
                {singleProduct?.description}
            </div>
            <div className="mt-5 text-[12px] flex">
                <div className="mr-5">
                    <strong className="font-[600]">{singleProduct?.rating.count}</strong> Likes
                </div>
                <div className="mr-5">
                ...
                <div className="mr-5">
                    <strong className="font-[600]">{singleProduct?.rating.rate}</strong> star rating
                </div>
            </div>
